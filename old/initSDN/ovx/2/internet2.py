...
CORES = {
  '1': {'dpid': '000000000000010%s'},
  '2': {'dpid': '000000000000020%s'},
  # '3': {'dpid': '000000000000030%s'},
  # '4': {'dpid': '000000000000040%s'},
  # '5': {'dpid': '000000000000050%s'},
  # '6': {'dpid': '000000000000060%s'},
  # '7': {'dpid': '000000000000070%s'},
  # '8': {'dpid': '000000000000080%s'},
  # '9': {'dpid': '000000000000090%s'},
  }
  ...
  def __init__(self, enable_all = True):
    ...
    for switch in CORES:
      for count in xrange(1, FANOUT + 1):
        # Add hosts
        host = 'h_s%s_%s' % (switch, count)
        ip = '10.0.%s.%s' % (switch, count)
    ...
    self.addLink(self.cores['1'], self.cores['2'])
